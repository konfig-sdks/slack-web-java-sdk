...
|------------- | ------------- | -------------|
| [**list**](AdminInviteRequestsDeniedApi.md#list) | **GET** /admin.inviteRequests.denied.list |  |


<a name="list"></a>
# **list**
> AdmininviteRequestsdeniedListResponse list(token).teamId(teamId).cursor(cursor).limit(limit).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling AdminInviteRequestsDeniedApi#list");

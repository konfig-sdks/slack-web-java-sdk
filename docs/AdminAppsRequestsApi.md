...
|------------- | ------------- | -------------|
| [**list**](AdminAppsRequestsApi.md#list) | **GET** /admin.apps.requests.list |  |


<a name="list"></a>
# **list**
> AdminappsrequestsListResponse list(token).limit(limit).cursor(cursor).teamId(teamId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling AdminAppsRequestsApi#list");

...
<a name="open"></a>
# **open**
> DialogOpenResponse open(token, dialog, triggerId).execute();
...
public class Example {
  public static void main(String[] args) {
    ...
    String dialog = "dialog_example"; // The dialog definition. This must be a JSON-encoded string.
    String triggerId = "triggerId_example"; // Exchange a trigger to post to the user.
    try {
      DialogOpenResponse result = client
              .dialog
              .open(token, dialog, triggerId)
              .execute();
      System.out.println(result);
      System.out.println(result.getOk());
    } catch (ApiException e) {
      System.err.println("Exception when calling DialogApi#open");
    ...
    try {
      ApiResponse<DialogOpenResponse> response = client
              .dialog
              .open(token, dialog, triggerId)
              .executeWithHttpInfo();
...
[**DialogOpenResponse**](DialogOpenResponse.md)

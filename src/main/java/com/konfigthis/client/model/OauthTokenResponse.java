...
public class OauthTokenResponse {
  ...
  public OauthTokenResponse ok(DefsOkTrue ok) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ok, oauthTokenResponse.ok)&&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OauthTokenResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null

...
public class ObjsComment {
  ...
  **/
   ...
   * @return the ObjsComment instance itself
   */
  public ObjsComment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.comment, objsComment.comment) &&
        ...
        Objects.equals(this.additionalProperties, objsComment.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comment, created, id, isIntro, isStarred, numStars, pinnedInfo, pinnedTo, reactions, timestamp, user, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ObjsComment>() {
           ...
           public ObjsComment read(JsonReader in) throws IOException {
             ...
             ObjsComment instance = thisAdapter.fromJsonTree(jsonObj);

...
public class ObjsFile {
  ...
  **/
  ...
  public ObjsFile reactions(List<ReactionObject> reactions) {
  ...
  public ObjsFile addReactionsItem(ReactionObject reactionsItem) {
  ...
  **/
   ...
   * @return the ObjsFile instance itself
   */
  public ObjsFile putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, objsFile.title) &&
        Objects.equals(this.channels, objsFile.channels) &&
        ...
        Objects.equals(this.additionalProperties, objsFile.additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ObjsFile>() {
           ...
           public ObjsFile read(JsonReader in) throws IOException {
             ...
             ObjsFile instance = thisAdapter.fromJsonTree(jsonObj);

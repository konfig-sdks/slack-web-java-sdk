...
public class TeamObjectPropertyIcon {
  ...
  public TeamObjectPropertyIcon() {
  }

  public TeamObjectPropertyIcon image102(String image102) {
  ...
  **/
  ...
  public TeamObjectPropertyIcon image132(String image132) {
  ...
  **/
  ...
  public TeamObjectPropertyIcon image230(String image230) {
  ...
  **/
  ...
  public TeamObjectPropertyIcon image34(String image34) {
  ...
  **/
  ...
  public TeamObjectPropertyIcon image44(String image44) {
  ...
  **/
  ...
  public TeamObjectPropertyIcon image68(String image68) {
  ...
  **/
  ...
  public TeamObjectPropertyIcon image88(String image88) {
  ...
  **/
  ...
  public TeamObjectPropertyIcon imageDefault(Boolean imageDefault) {
  ...
  **/
   ...
   * @return the TeamObjectPropertyIcon instance itself
   */
  public TeamObjectPropertyIcon putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    TeamObjectPropertyIcon teamObjectPropertyIcon = (TeamObjectPropertyIcon) o;
    return Objects.equals(this.image102, teamObjectPropertyIcon.image102) &&
        Objects.equals(this.image132, teamObjectPropertyIcon.image132) &&
        Objects.equals(this.image230, teamObjectPropertyIcon.image230) &&
        Objects.equals(this.image34, teamObjectPropertyIcon.image34) &&
        Objects.equals(this.image44, teamObjectPropertyIcon.image44) &&
        Objects.equals(this.image68, teamObjectPropertyIcon.image68) &&
        Objects.equals(this.image88, teamObjectPropertyIcon.image88) &&
        Objects.equals(this.imageDefault, teamObjectPropertyIcon.imageDefault)&&
        Objects.equals(this.additionalProperties, teamObjectPropertyIcon.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class TeamObjectPropertyIcon {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to TeamObjectPropertyIcon
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TeamObjectPropertyIcon.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TeamObjectPropertyIcon is not found in the empty JSON string", TeamObjectPropertyIcon.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TeamObjectPropertyIcon.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TeamObjectPropertyIcon' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TeamObjectPropertyIcon> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TeamObjectPropertyIcon.class));

       return (TypeAdapter<T>) new TypeAdapter<TeamObjectPropertyIcon>() {
           @Override
           public void write(JsonWriter out, TeamObjectPropertyIcon value) throws IOException {
           ...
           @Override
           public TeamObjectPropertyIcon read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TeamObjectPropertyIcon instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TeamObjectPropertyIcon given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TeamObjectPropertyIcon
  * @throws IOException if the JSON string is invalid with respect to TeamObjectPropertyIcon
  */
  public static TeamObjectPropertyIcon fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TeamObjectPropertyIcon.class);
  }

 /**
  * Convert an instance of TeamObjectPropertyIcon to an JSON string
  *
  * @return JSON string
  */

...
public class ObjsMessageAttachmentsInner {
  ...
  **/
   ...
   * @return the ObjsMessageAttachmentsInner instance itself
   */
  public ObjsMessageAttachmentsInner putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.fallback, objsMessageAttachmentsInner.fallback) &&
        ...
        Objects.equals(this.additionalProperties, objsMessageAttachmentsInner.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(fallback, id, imageBytes, imageHeight, imageUrl, imageWidth, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ObjsMessageAttachmentsInner>() {
           ...
           public ObjsMessageAttachmentsInner read(JsonReader in) throws IOException {
             ...
             ObjsMessageAttachmentsInner instance = thisAdapter.fromJsonTree(jsonObj);

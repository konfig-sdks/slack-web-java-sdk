...
public class AdminInviteRequestsApprovedApiGenerated {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public AdminInviteRequestsApprovedApiGenerated() throws IllegalArgumentException {
        this(Configuration.getDefaultApiClient());
    }

    public AdminInviteRequestsApprovedApiGenerated(ApiClient apiClient) throws IllegalArgumentException {
    ...
    private okhttp3.Call listCall(String token, String teamId, String cursor, Integer limit, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listValidateBeforeCall(String token, String teamId, String cursor, Integer limit, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'token' is set
        if (token == null) {
            throw new ApiException("Missing the required parameter 'token' when calling list(Async)");
        }

        return listCall(token, teamId, cursor, limit, _callback);

    }


    private ApiResponse<AdmininviteRequestsapprovedListResponse> listWithHttpInfo(String token, String teamId, String cursor, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = listValidateBeforeCall(token, teamId, cursor, limit, null);
        Type localVarReturnType = new TypeToken<AdmininviteRequestsapprovedListResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listAsync(String token, String teamId, String cursor, Integer limit, final ApiCallback<AdmininviteRequestsapprovedListResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listValidateBeforeCall(token, teamId, cursor, limit, _callback);
        Type localVarReturnType = new TypeToken<AdmininviteRequestsapprovedListResponse>(){}.getType();
    ...
    public class ListRequestBuilder {
        ...
        public AdmininviteRequestsapprovedListResponse execute() throws ApiException {
            ApiResponse<AdmininviteRequestsapprovedListResponse> localVarResp = listWithHttpInfo(token, teamId, cursor, limit);
        ...
        public ApiResponse<AdmininviteRequestsapprovedListResponse> executeWithHttpInfo() throws ApiException {
            return listWithHttpInfo(token, teamId, cursor, limit);
        }
        ...
        public okhttp3.Call executeAsync(final ApiCallback<AdmininviteRequestsapprovedListResponse> _callback) throws ApiException {
            return listAsync(token, teamId, cursor, limit, _callback);
        }
    }

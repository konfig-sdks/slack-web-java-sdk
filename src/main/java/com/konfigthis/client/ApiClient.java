...
public class ApiClient extends ApiClientCustom {
    ...
    private String tokenUrl = "https://slack.com/api/oauth.access";
    ...
    private RetryingOAuth setupOauth(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        RetryingOAuth oauth = new RetryingOAuth(getTokenUrl(), clientId, OAuthFlow.ACCESS_CODE, clientSecret, parameters);
        authentications.put("slackAuth", oauth);
        return oauth;
    }
    ...
    private void init() {
        ...
        setUserAgent("Konfig/1.7.0/java");
     ...
     * Set token url
     *
     * @param tokenUrl Token URL for oauth (e.g https://slack.com/api/oauth.access)
     * @return An instance of OkHttpClient
     */
